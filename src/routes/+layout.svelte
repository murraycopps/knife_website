...
<header
	class="fixed top-0 left-0 right-0 z-50 flex flex-row items-center gap-2 p-2 text-xl align-middle bg-oglala text-white"
>
...
<main class="mt-16 pt-4 overflow-y-scroll">
	<slot />
</main>
