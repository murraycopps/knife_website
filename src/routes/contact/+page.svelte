...
<div class="grid grid-cols-2 gap-4 p-8 items-center h-full">
	<div>
		<h2 class="text-3xl text-center mb-4">Contact me</h2>
		<p class="text-2xl ">
			If you would like to get in touch with me, please fill out the form and I will get back to you
			as soon as possible. Please note that I am not currently accepting custom orders at this time
			but feel free to reach out with a design you have in mind and I will see what I can do.
			<br /> <br />
